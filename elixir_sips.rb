require_relative './elixir_sips_utilities'

module ElixirSips
  class Episode < Struct.new(:identifier, :title, :synopsis, :cover_image_base, :url, :free, :length)
  ...
  def episodes_til_209
    [
      Episode.new("001", "001: Introduction and Installing Elixir",
           ...
           true,
           346),
      Episode.new("002", "002: Basic Elixir",
      ...
      Episode.new("007", "007: Dynamo, Part 1",
            ...
            true,
            458),
      Episode.new("008", "008: Dynamo, Part 2",
            ...
            false,
            685),
      Episode.new("009", "009: Dynamo, Part 3",
            ...
            false,
            406),
      Episode.new("010", "010: List Comprehensions",
      ...
      Episode.new("012", "012: Processes",
            ...
            false,
            589),
      Episode.new("013", "013: Processes, Part 2",
            ...
            false,
            624),
      Episode.new("014", "014: OTP Part 1 - Servers",
            ...
            false,
            555),
      Episode.new("015", "015: OTP Part 2 - Finite State Machines",
            ...
            false,
            775),
      Episode.new("016", "016: Pipe Operator",
            ...
            false,
            802),
      Episode.new("017", "017: Enum, Part 1",
            ...
            false,
            303),
      Episode.new("018", "018: Enum, Part 2",
      ...
      Episode.new("036", "036: Weber, Part 2 - Performance",
            ...
            false,
            1072),
      Episode.new("037", "037: ExLager",
            "Fantastic logging for your application.",
            "037_ExLager_Screenshot",
            "/episodes/037_exlager.html",
            false,
            314),
      Episode.new("038", "038: Binaries - Deconstructing and Constructing",
            ...
            false,
            188),
      Episode.new("039", "039: Binaries - Deconstructing an IP Packet",
      ...
      Episode.new("041", "041: File, Part 1",
            ...
            false,
            195),
      Episode.new("042", "042: File, Part 2",
            ...
            false,
            234),
      Episode.new("043", "043: Releases With Relex",
      ...
      Episode.new("045", "045: Distribution, Part 2",
            ...
            false,
            190),
      Episode.new("046", "046: Markdown Server, Part 1",
            ...
            false,
            408),
      Episode.new("047", "047: Markdown Server, Part 2",
            ...
            false,
            560),
      Episode.new("048", "048: Markdown Server, Part 3",
            ...
            false,
            525),
      Episode.new("049", "049: Markdown Server, Part 4",
            ...
            false,
            471),
      Episode.new("050", "050: Markdown Server, Part 5",
            ...
            false,
            255),
      Episode.new("051", "051: BEAM Toolbox, Part 1",
            ...
            false,
            478),
      Episode.new("052", "052: BEAM Toolbox, Part 2",
            ...
            false,
            599),
      Episode.new("053", "053: BEAM Toolbox, Part 3",
            ...
            false,
            460),
      Episode.new("054", "054: Maps, Part 1",
            ...
            true,
            171),
      Episode.new("055", "055: Maps, Part 2 - Structs",
            ...
            true,
            143),
      Episode.new("056", "056: Migrating Records to Maps",
            ...
            false,
            179),
      Episode.new("057", "057: BEAM Toolbox, Part 4",
            ...
            false,
            514),
      Episode.new("058", "058: BEAM Toolbox, Part 5",
            ...
            false,
            319),
      Episode.new("059", "059: Custom Mix Tasks",
            ...
            false,
            177),
      Episode.new("060", "060: New Style Comprehensions",
      ...
      Episode.new("066", "066: Plug.Static",
            ...
            false,
            120),
      Episode.new("067", "067: Deploying to Heroku",
      ...
      Episode.new("072", "072: WxCalc, Part 2",
            ...
            false,
            1126),
      Episode.new("073", "073: Process Dictionaries",
      ...
      Episode.new("088", "088: Porcelain",
            ...
            false,
            603),
      Episode.new("089", "089: Protocol Buffers",
            ...
            false,
            240),
      Episode.new("090", "090: Websockets Terminal",
            ...
            false,
            780),
      Episode.new("091", "091: Test Coverage",
            ...
            false,
            155),
      Episode.new("092", "092: Link Extractor",
            ...
            false,
            836),
      Episode.new("093", "093: Link Extractor, Part 2",
            ...
            false,
            557),
      Episode.new("094", "094: Link Extractor, Part 3",
            ...
            false,
            398),
      Episode.new("095", "095: Link Extractor, Part 4",
            ...
            false,
            799),
      Episode.new("096", "096: Arduino Motor Driver",
            ...
            false,
            362),
      Episode.new("097", "097: BEAM Toolbox, Part 6",
            ...
            false,
            382),
      Episode.new("098", "098: Contributing to Open Source",
            ...
            false,
            994),
      Episode.new("099", "099: BEAM Toolbox, Part 7",
            ...
            false,
            524),
      Episode.new("100", "100: BEAM Toolbox, Part 8",
            ...
            false,
            587),
      Episode.new("101", "101: BEAM Toolbox, Part 9",
            ...
            false,
            743),
      Episode.new("102", "102: BEAM Toolbox, Part 10",
            ...
            false,
            357),
      Episode.new("103", "103: BEAM Toolbox, Part 11",
            ...
            false,
            260),
      Episode.new("104", "104: Ruby to Elixir via BERT-RPC",
      ...
      Episode.new("107", "107: Phoenix Release",
            ...
            false,
            236),
      Episode.new("108", "108: Release Upgrades",
      ...
      Episode.new("110", "110: ExTwitter",
            ...
            false,
            180),
      Episode.new("111", "111: ExTwitter, Part 2",
      ...
      Episode.new("116", "116: Wx Extris Part 3 - Refactoring",
            ...
            false,
            470),
      Episode.new("117", "117: Wx Extris Part 4 - Testing",
            ...
            false,
            684),
      Episode.new("118", "118: Wx Extris Part 5",
            ...
            false,
            345),
      Episode.new("119", "119: Wx Extris Part 6",
            ...
            false,
            726),
      Episode.new("120", "120: Wx Extris Part 7",
            ...
            false,
            2117),
      Episode.new("121", "121: Wx Extris Part 8",
      ...
      Episode.new("125", "125: Dialyzer",
            ...
            false,
            289),
      Episode.new("126", "126: Piping Into Elixir",
            ...
            false,
            96),
      Episode.new("127", "127: SSH Client Commands",
            ...
            false,
            107),
      Episode.new("128", "128: Managing Docker",
      ...
      Episode.new("131", "131: ExProf",
            ...
            false,
            223),
      Episode.new("132", "132: Randomness in the Erlang VM",
            ...
            false,
            245),
      Episode.new("133", "133: Boltun - Postgres Listen+Notify",
            ...
            false,
            370),
      Episode.new("134", "134: Elastic Search with Tirexs",
      ...
      Episode.new("136", "136: Interfacing with Asterisk",
            ...
            false,
            365),
      Episode.new("137", "137: Asterisk AGI with Elixir",
            ...
            false,
            230),
      Episode.new("138", "138: Monitors and Links",
      ...
      Episode.new("143", "143: phoenix_generator",
            ...
            false,
            385),
      Episode.new("144", "144: Erlang's `calendar` module",
      ...
      Episode.new("146", "146: mailman",
            ...
            false,
            290),
      Episode.new("147", "147: webassembly",
            ...
            false,
            216),
      Episode.new("148", "148: ejabberd with Elixir",
            ...
            false,
            381),
      Episode.new("149", "149: ejabberd Packet Filters",
      ...
      Episode.new("152", "152: erlang_js",
            ...
            false,
            210),
      Episode.new("153", "153: Phoenix APIs and CORS",
      ...
      Episode.new("155", "155: OAuth2 Code Spelunking",
            ...
            false,
            263),
      Episode.new("156", "156: Interacting with Amazon's APIs with erlcloud",
            ...
            false,
            128),
      Episode.new("157", "157: Playing with the Code Module, Part 1 - eval_string",
            ...
            false,
            186),
      Episode.new("158", "158: SOAP with Detergentex",
            ...
            false,
            197),
      Episode.new("159", "159: Simple One for One Supervisors",
      ...
      Episode.new("160", "160: MultiDef",
            ...
            false,
            108),
      Episode.new("161", "161: Building a Cron System, Part 1",
            ...
            false,
            754),
      Episode.new("162", "162: Building a Cron System, Part 2",
            ...
            false,
            589),
      Episode.new("163", "163: Building a Cron System, Part 3",
      ...
      Episode.new("165", "165: Accounting 101",
            ...
            false,
            1345),
      Episode.new("166", "166: Implementing Logo",
            ...
            true,
            824),
      Episode.new("167", "167: Implementing Logo, Part 2 (the drawening)",
            ...
            true,
            705),
      Episode.new("168", "168: Continuous Integration",
            ...
            true,
            444),
      Episode.new("169", "169: Fractals, Part 2",
            ...
            false,
            493),
      Episode.new("170", "170: Building a Slack Bot",
            ...
            false,
            406),
      Episode.new("171", "171: Erlang 18 and Time",
            ...
            false,
            441),
      Episode.new("172", "172: Arc File Uploads",
            ...
            false,
            393),
      Episode.new("173", "173: Continuous Deployment",
            ...
            false,
            308),
      Episode.new("174", "174: ElixirFriends - Saving Tweets with Streams and Filters",
            ...
            false,
            380),
      Episode.new("175", "175: Pagination with Ecto and Phoenix",
            ...
            false,
            634),
      Episode.new("176", "176: Prettying Up ElixirFriends",
            ...
            false,
            707),
      Episode.new("177", "177: Audio Visualizer",
            ...
            false,
            938),
      Episode.new("178", "178: Memory Leaks",
            ...
            false,
            265),
      Episode.new("179", "179: Rules Engine",
            ...
            false,
            1278),
      Episode.new("180", "180: Collectable",
            ...
            false,
            355),
      Episode.new("181", "181: Native Compilation with HiPE",
      ...
      Episode.new("183", "183: React with Phoenix",
            ...
            false,
            472),
      Episode.new("184", "184: React with Phoenix Channels",
            ...
            false,
            404),
      Episode.new("185", "185: Mix Archives",
            ...
            false,
            118),
      Episode.new("186", "186: Automatically Connecting Nodes",
            ...
            false,
            214),
      Episode.new("187", "187: Compiling a Custom AST Into Elixir Functions",
      ...
      Episode.new("192", "192: Interesting I/O, Part 2 - Input with `tty_sl`",
            ...
            false,
            617),
      Episode.new("193", "193: Linting with Dogma",
            ...
            false,
            450),
      Episode.new("194", "194: Interoperability - Ports",
            ...
            false,
            753),
      Episode.new("195", "195: Spaceships",
            ...
            false,
            268),
      Episode.new("196", "196: Crashing the BEAM",
      ...
      Episode.new("197", "197: gproc",
            ...
            false,
            609),
      Episode.new("198", "198: Elixir and Unity3D",
            ...
            false,
            184),
      Episode.new("199", "199: Modeling a Virtual Machine",
            ...
            false,
            1396),
      Episode.new("200", "200: Custom Types in Ecto",
            ...
            false,
            471),
      Episode.new("201", "201: Tracing and Debugging with erlyberly",
            ...
            false,
            213),
      Episode.new("202", "202: Exception Monitoring with Honeybadger.io",
...
web application.",
      ...
      Episode.new("205", "205: The Opposite of Mocks",
            ...
            false,
            564),
      Episode.new("206", "206: Getting a Nested Module From a String",
      ...
      Episode.new("207", "207: XMLRPC",
            ...
            false,
            316),
      Episode.new("208", "208: Compile Time Interface Policy Enforcement",
            ...
            false,
            583),
      Episode.new("209", "209: Integration Tests with Hound",
  ...
  def episodes_since_209
    ElixirSips::Utilities.episodes_since_209
  end

  def episode_by_title(title)
    episodes.detect{|e| e.title == title}
  end
